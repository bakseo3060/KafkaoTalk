...
It was a project that could implement the logic of the chat service in an object-oriented way.
In addition, by linking with Kafka, I was able to think about how accounts, chat rooms, and chat messages needed for chat services in the Kafaka ecosystem should be connected organically. 
The project itself was a simple implementation, but it was a great experience to fully ponder the issues that arise when users use the chat service.
